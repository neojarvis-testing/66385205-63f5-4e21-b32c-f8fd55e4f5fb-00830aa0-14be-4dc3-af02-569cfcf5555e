...
public class FooterPageActions {
    ...
    public void verifyTermsAndConditions(){
        try{
            ...
            String termsAndConditionsURL = "https://www.fnp.com/info/terms-and-conditions";
    ...
    public void verifyPrivacyPolicy(){
        try{
            ...
            String privacyPolicyURL = "https://www.fnp.com/info/privacy-policy";
    ...
    public void verifyTermsOfUse(){
        try{
            ...
            String termsOfUseURL = "https://www.fnp.com/info/terms-of-use";
    ...
    public void verifyDisclaimer(){
        try{
            ...
            String disclaimerURL = "https://www.fnp.com/info/disclaimer";
    ...
    public void verifyAboutUs(){
        try{
            ...
            String aboutUsURL = "https://www.fnp.com/info/about-us";
    ...
    public void verifyFNPTeam(){
        try{
            ...
            String disclaimerURL = "https://www.fnp.com/info/fnp-team";
            assertion.verifyUrl(disclaimerURL);
            LoggerHandler.info("Disclaimer url is correct");
            extentTest.log(Status.PASS, "Disclaimer url is correct");
            helper.navigateBack();
    ...
    public void verifyCareers(){
        try{
            ...
            String careersURL = "https://www.fnp.com/info/careers";
    ...
    public void verifyTestimonials(){
        try{
            ...
            String testimonialsURL = "https://www.fnp.com/info/testimonials";
            ...
            Assertion.verifyText(FooterLocators.policyInfo, "Policy info");
